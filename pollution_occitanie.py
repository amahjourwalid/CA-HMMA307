...
# Ajout d'une colonne de temporalité "day" au tableau et affichage des 
# nouvelles colonnes
...
sns.catplot(x="polluant", y=df_poccitanieO3_ville.columns[12], hue="nom_com", data=df_poccitanieO3_ville, kind="violin", legend=False)
